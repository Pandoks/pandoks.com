...
| `infra/github.ts`        | OIDC AWS provider/role (`:72, 77`), prod-only action secrets (OVH pair at `:60-70`), Tailscale CI OAuth (`:128`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- **CLI**: `scripts/cluster/main.sh:18-34`. Subcommands: `k3d`
  (`scripts/cluster/k3d.sh:135`), `deploy` (`scripts/cluster/deploy.sh:141`).
