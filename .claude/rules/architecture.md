...
| `infra/github.ts`        | OIDC AWS role (`:59`), prod-only action secrets, Tailscale CI OAuth (`:110`), Dependabot security-updates off (`:133` — Renovate is the sole security-PR opener; Dependabot alerts stay on as its data source).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
