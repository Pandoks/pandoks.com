...
const (
	Handler_Handle_FullMethodName = "/pandoks.queueworker.runtime.v1.Handler/Handle"
)
...
func RegisterHandlerServer(s grpc.ServiceRegistrar, srv HandlerServer) {
	// If the following call panics, it indicates UnimplementedHandlerServer was
...
var Handler_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pandoks.queueworker.runtime.v1.Handler",
	...
	Metadata: "packages/queueworker/runtime/v1/handler.proto",
}
