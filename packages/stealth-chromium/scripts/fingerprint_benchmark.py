...
TARGETS = [
    ...
    {"name": "bl_dns", "url": "https://browserleaks.com/dns", "settle": 12,
     "tier": "surface",
     "scores": {"servers": r"(\d+)\s*(?:DNS\s*)?servers?"},
     "lines": ["DNS Address", "DNS Server", "ISP", "Country", "servers",
               "amazon", "AWS", "google", "datacenter"]},
